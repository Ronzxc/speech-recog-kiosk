...
layout_tab1 = [[sg.Text('Content for Tab 1', background_color=('#FF8A08'))],
               [sg.Column([
                [sg.Image(filename=menu.chicken[1], size=(75, 75), pad=10),sg.Text(text=menu.chicken[0])], 
                [sg.Image(filename=menu.burgersteak[1], size=(75, 75), pad=10),sg.Text(text=menu.burgersteak[0])]], justification='center', background_color='#FFC100')]]
layout_tab2 = [[sg.Text('Content for Tab 2', background_color=('#FF8A08'))],
               [sg.Column([
                [sg.Image(filename=menu.burger[1], size=(75, 75), pad=10),sg.Text(text=menu.burger[0])], 
                [sg.Image(filename=menu.fries[1], size=(75, 75), pad=10),sg.Text(text=menu.fries[0])]], justification='center', background_color='#FFC100')]]
